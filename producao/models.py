...
class Bloco(models.Model):
    ...
    comprimento_bruto = DecimalField(max_digits=6, decimal_places=3, default=0)
    altura_bruto = DecimalField(max_digits=6, decimal_places=3, default=0)
    largura_bruto = DecimalField(max_digits=6, decimal_places=3, default=0)
